...
st.set_page_config(page_title="Real-Time Sign Language Recognition", page_icon="🤟", layout="wide")
...
def main():
    ...
    if ctx.video_transformer:
        ...
        while ctx.state.playing:
            pred_placeholder.write(f"**Detected:** {ctx.video_transformer.current_prediction}")
